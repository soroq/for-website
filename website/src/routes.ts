...
export const routes: RouteEntry[] = [
  ...
  { path: "/what-is-soroq.html", htmlEntry: "what-is-soroq.html", surface: "docs", component: null },
  { path: "/before-you-begin.html", htmlEntry: "before-you-begin.html", surface: "docs", component: null },
  { path: "/getting-started.html", htmlEntry: "getting-started.html", surface: "docs", component: null },
  { path: "/installation.html", htmlEntry: "installation.html", surface: "docs", component: null },
  { path: "/authentication.html", htmlEntry: "authentication.html", surface: "docs", component: null },
  { path: "/cli.html", htmlEntry: "cli.html", surface: "docs", component: null },
  { path: "/soroq-yaml-reference.html", htmlEntry: "soroq-yaml-reference.html", surface: "docs", component: null },
  { path: "/compatibility-limitations.html", htmlEntry: "compatibility-limitations.html", surface: "docs", component: null },
  { path: "/security-model.html", htmlEntry: "security-model.html", surface: "docs", component: null },
  { path: "/product-status.html", htmlEntry: "product-status.html", surface: "docs", component: null },
